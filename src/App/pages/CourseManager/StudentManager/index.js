...
const StudentManager = ({ currentCourse, visible, setVisible }) => {
    ...
    const updateStudents = () => {
        ...
        axios
            .put(`${process.env.REACT_APP_API_URL}/admin/course/${currentCourse._id}/students`,
                {
                    students: students
                },
                {
    ...
    useEffect(() => {
        ...
        if (currentCourse) {
            axios
                .get(`${process.env.REACT_APP_API_URL}/admin/course/${currentCourse._id}/students`, {
                    headers: {
                        Authorization: token,
                    },
        ...
        <Aux>
            <Row>
                <Col>
                    <Card>
                        <Card.Header>
                            <Card.Title as="h5"> <Text strong>{currentCourse.name}</Text> - List students </Card.Title>
                            <Button type="primary"
                                style={{ float: 'right' }}
                                onClick={() => {
                                    setVisible(false);
            ...
            <ExcelStudentModal currentCourse={currentCourse} updateStudents={setStudents} visible={isModalVisible} setVisible={setModalVisible} />
